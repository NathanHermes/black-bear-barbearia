...
public class DatabaseBuilder {
    ...
    private static void populateUser() throws SQLException {
        ...
        final String sql = "INSERT INTO user (fullName, email, phone, login, passwordHash, active) " +
                "VALUES ('%s', '%s', '%s', '%s', '%s', %b)";

        stmt.addBatch(String.format(sql, "Black Bear ADM", "blackbear@adm.com", "(16) 99999-9999", "BB", "123", Boolean.TRUE));
        stmt.addBatch(String.format(sql, "Grace Hopper", "grace.hopper@email.com", "(13) 2745-5802", "Grace", "Hopper", Boolean.TRUE));
        stmt.addBatch(String.format(sql, "John Backus", "john.backus@email.com", "(24) 2208-8210", "John", "Backus", Boolean.TRUE));
        stmt.addBatch(String.format(sql, "Bill Gates", "gates.bill@email.com", "(33) 2544-6585", "Gates", "Bill", Boolean.TRUE));
        stmt.addBatch(String.format(sql, "Brian Kernighan", "brian.kernighan@email.com", "(45) 2583-1359", "Brian", "Brian", Boolean.TRUE));
        stmt.addBatch(String.format(sql, "Ken Thompson", "ken.thompson@email.com", "(65) 2642-6225", "Thompson", "Ken", Boolean.TRUE));
        stmt.executeBatch();
    ...
    private static void populateAddress() throws SQLException {
        ...
        final String sql = "INSERT INTO address (address, number, complement, district, city, user) " +
                "VALUES ('%s', '%s', '%s', '%s', '%s', %d)";
    ...
    private static void populateBooking() throws SQLException {
        ...
        final String sql = "INSERT INTO booking (date, paid, client, service, user) " +
                "VALUES ('%s', %b, %d, %d, %d)";
